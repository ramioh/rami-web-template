...
Layered architecture constrains the direction of dependency between projects. It states that dependency should always point inwards. Additionally, the Starter Web Template applies **more** constraints to dependencies between projects, as described below:
