...
* `0.Framework`: Not specific to the architecture, but could still be looked at as the outermost layer. It contains the `Host` project, which acts as the composition root of the application.
